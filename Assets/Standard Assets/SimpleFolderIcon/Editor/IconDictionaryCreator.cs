...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Standard Assets/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Standard Assets/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Standard Assets/SimpleFolderIcon/Icons/{f.Name}", typeof(FolderIconSO));
